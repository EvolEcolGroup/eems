...
void Params::check_input_arguments() {
  ...
  check_condition(nSites >= nIndiv, "Check that nSites >= nIndiv");
  ...
  check_condition(boost::filesystem::exists(datapath + ".diffs"),
		  "Check that " + datapath + ".diffs exists");
